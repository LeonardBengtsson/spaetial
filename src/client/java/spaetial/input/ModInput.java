...
public enum ModInput implements Translatable {
    ...
    CHANGE_STACK_SPACING_IN_PLANE("change_stack_spacing_in_plane", Category.COPY, "key.g", KeyModifiers.ALT),
    CHANGE_STACK_SPACING_FORWARDS("change_stack_spacing_forwards", Category.COPY, "scroll.up", KeyModifiers.ALT, true, new Vec3i(0, 0, 1)),
    CHANGE_STACK_SPACING_BACKWARDS("change_stack_spacing_backwards", Category.COPY, "scroll.down", KeyModifiers.ALT, true, new Vec3i(0, 0, -1)),
    CHANGE_STACK_SPACING_RIGHT("change_stack_spacing_right", Category.COPY, "scroll.right", KeyModifiers.ALT, true, new Vec3i(1, 0, 0)),
    CHANGE_STACK_SPACING_LEFT("change_stack_spacing_left", Category.COPY, "scroll.left", KeyModifiers.ALT, true, new Vec3i(-1, 0, 0)),
    INCREASE_LINE_STACK_SIZE("increase_stack_size", Category.COPY, "scroll.up", KeyModifiers.CTRL, true),
    DECREASE_LINE_STACK_SIZE("decrease_stack_size", Category.COPY, "scroll.down", KeyModifiers.CTRL, true),
    CHANGE_VOLUME_STACK_SIZE_IN_PLANE("change_volume_stack_size_in_plane", Category.COPY, "key.g", KeyModifiers.CTRL),
    CHANGE_VOLUME_STACK_SIZE_FORWARDS("change_volume_stack_size_forwards", Category.COPY, "scroll.up", KeyModifiers.CTRL, true, new Vec3i(0, 0, 1)),
    CHANGE_VOLUME_STACK_SIZE_BACKWARDS("change_volume_stack_size_backwards", Category.COPY, "scroll.down", KeyModifiers.CTRL, true, new Vec3i(0, 0, -1)),
    CHANGE_VOLUME_STACK_SIZE_RIGHT("change_volume_stack_size_right", Category.COPY, "scroll.right", KeyModifiers.CTRL, true, new Vec3i(1, 0, 0)),
    CHANGE_VOLUME_STACK_SIZE_LEFT("change_volume_stack_size_left", Category.COPY, "scroll.left", KeyModifiers.CTRL, true, new Vec3i(-1, 0, 0)),
